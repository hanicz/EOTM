...
('goog', 'Alphabet Inc Class C', 'GOOG', 'US');
...
('B',CURRENT_TIMESTAMP(),10,'goog',7,1,{ts '2023-01-01 00:00:00.00'},0,1),
('S',CURRENT_TIMESTAMP(),10,'goog',8,1,{ts '2023-02-01 00:00:00.00'},0,1),
('B',CURRENT_TIMESTAMP(),5,'goog',9,1,{ts '2023-03-01 00:00:00.00'},0,1);
...
-- (1, 'intc', 'PERCENT_UNDER', -20.0),
-- (1, 'intc', 'PRICE_UNDER', 100.5),
-- (1, 'amd', 'PRICE_OVER', 100.0);
